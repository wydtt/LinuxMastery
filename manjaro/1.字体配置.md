...
https://www.cnblogs.com/hulk190/p/11441497.html
...
其中noto-fonts-cjk 是本来就安装的卸载的时候别卸载它欧
slociv@gg ~> cd .config/
slociv@gg ~/.config> mkdir fontconfig
slociv@gg ~/.config> cd fontconfig/
slociv@gg ~/.c/fontconfig> sudo vim fonts.conf
slociv@gg ~/.c/fontconfig> 
